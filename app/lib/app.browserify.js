/*globals Meteor: true, React: true, Package: true, $: true, mui:true, injectTapEventPlugin: true, ReactLayout: true */
...
ReactLayout.renderServer = function(layoutClass, regions) {
  ...
  if(Package['meteorhacks:flow-router-ssr']) {
    var FlowRouter = Package['meteorhacks:flow-router-ssr'].FlowRouter;
